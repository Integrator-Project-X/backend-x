...
import { JobPositionDto } from './jobposition.dto';
...
export class UpdateAppointmentstatusDTO extends PartialType(JobPositionDto) {
  @ApiPropertyOptional({
    type: 'string',
    nullable: true,
    example: null,
    description: 'Only null is allowed here to reactivate the Job position.',
  })
  @IsOptional()
